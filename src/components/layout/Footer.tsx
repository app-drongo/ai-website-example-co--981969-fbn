...
const DEFAULT_FOOTER = {
  logoText: 'Example Co.',
  companyDescription:
    'Empowering businesses with innovative solutions and exceptional service. Trusted by over 10,000 companies worldwide to drive growth and success.',
  contactEmail: 'hello@example.co',
  contactPhone: '+1 (555) 123-4567',
  contactAddress: '123 Innovation Drive, Tech Hub',
  newsletterTitle: 'Stay Connected',
  newsletterPlaceholder: 'Enter your email address',
  newsletterDisclaimer: 'Get industry insights and updates. No spam, unsubscribe anytime.',
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Enterprise', href: '/enterprise', editableId: 'link-footer-enterprise' },
        {
          name: 'Small Business',
          href: '/small-business',
          editableId: 'link-footer-small-business',
        },
        ...
        { name: 'Training', href: '/training', editableId: 'link-footer-training' },
        {
          name: 'Custom Development',
          href: '/custom-development',
          editableId: 'link-footer-custom-development',
        },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'Investors', href: '/investors', editableId: 'link-footer-investors' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'API Reference', href: '/api-docs', editableId: 'link-footer-api-reference' },
        { name: 'System Status', href: '/status', editableId: 'link-footer-system-status' },
        { name: 'Community Forum', href: '/community', editableId: 'link-footer-community-forum' },
        { name: 'Contact Support', href: '/support', editableId: 'link-footer-contact-support' },
      ],
    },
    {
  ...
  const bottomLinks = [
    ...
    { name: 'Partner Portal', href: '/partners', editableId: 'link-footer-partner-portal' },
  ];
