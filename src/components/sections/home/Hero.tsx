...
const DEFAULT_HERO = {
  badge: 'New: Smart Testing Platform',
  title: 'Launch your website with confidence using',
  titleHighlight: 'automated testing',
  description:
    'Comprehensive testing suite that catches bugs before your users do. Perfect for developers, agencies, and growing businesses.',
  features: [
  ...
  statsLabel1: 'Tests Run',
  statsValue1: '2M+ daily',
  statsLabel2: 'Bug Detection',
